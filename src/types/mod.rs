...
pub struct Context {
    ...
    functions: HashMap<String, Rc<dyn Fn(&[Expr]) -> Result<Expr, MathError>>>,
}
...
impl fmt::Debug for Context {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("Context")
            ...
            .field("functions", &format!("{} custom functions", self.functions.len()))
            .finish()
    }
}
...
impl Expr {
    ...
    pub fn degree(&self, var: &str) -> u32 {
        match self {
            ...
            Expr::Binary { op: BinaryOp::Add | BinaryOp::Subtract, left, right } => {
